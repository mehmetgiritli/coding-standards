...
namespace CustomPHPCS\Sniffs\Namespaces;

use CustomPHPCS\Tools\AbstractSniff;
use CustomPHPCS\Tools\Traits\CommentingTrait;
use CustomPHPCS\Tools\Traits\NamespaceTrait;
