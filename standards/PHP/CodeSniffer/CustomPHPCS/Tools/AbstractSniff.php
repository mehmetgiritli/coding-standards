...
abstract class AbstractSniff implements Sniff {
     ...
     *
     * @param  array|integer|string $search
     * @param  array                $token
     * @return boolean
     */
     ...
     *
     * @param  File    $phpcsFile
     * @param  integer $openingBraceIndex
     * @param  integer $closingBraceIndex
     * @return boolean
     */
     ...
     * @return integer|null Stackpointer value of docblock end tag, or null if cannot be found
     */
